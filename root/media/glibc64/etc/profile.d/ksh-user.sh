...
export PATH XDG_CACHE_HOME XDG_CONFIG_HOME XDG_DATA_HOME ENV HISTCONTROL \
       HISTFILE HISTSIZE LESSHISTFILE GNUPGHOME PASSWORD_STORE_DIR VISUAL \
       EDITOR PAGER GRIPHOME PS1
